...
export default function MyFiles() {
  ...
  const loadCase = async () => {
    ...
    try {
      ...
      const data = await r.json() as { caseId: number };
  ...
  return (
    <AppLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground">My Case Files</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          Browse and upload documents into your case folders. Files are securely stored in Google Drive.
        </p>
      </div>
