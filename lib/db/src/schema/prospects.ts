...
export const prospectsTable = pgTable("prospects", {
  ...
  roadmapUploadedAt: timestamp("roadmap_uploaded_at", { withTimezone: true }),
  roadmapUploadedFileName: text("roadmap_uploaded_file_name"),
  roadmapUploadedData: text("roadmap_uploaded_data"),
